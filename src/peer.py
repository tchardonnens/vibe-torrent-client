...
class Peer:
    ...
    def __init__(self, ip: str, port: int, info_hash: bytes, peer_id: bytes) -> None:
        ...
        self.bitfield: Optional[Set[int]] = None
        self.choked = True
    ...
    async def receive_message(self, timeout: Optional[float] = None) -> Tuple[MessageType, bytes]:
        """
        ...
        try:
            ...
            raise PeerError("Message receive timeout")
        except Exception as e:
            raise PeerError(f"Error receiving message: {e}")
