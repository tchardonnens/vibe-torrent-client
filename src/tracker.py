...
class Tracker:
    ...
    async def _announce_http(self) -> Dict[str, any]:
        ...
        try:
            ...
            raise TrackerError("Tracker request timed out")
        except Exception as e:
            raise TrackerError(f"HTTP tracker error: {e}")
    ...
    async def _announce_udp(self) -> Dict[str, any]:
        ...
        try:
            ...
            raise TrackerError(f"UDP tracker error: {e}")
    
    async def _udp_connect(self, sock: socket.socket, addr: Tuple[str, int], loop: asyncio.AbstractEventLoop) -> Tuple[int, int]:
        """
        ...
        try:
            ...
            raise TrackerError("UDP connect timeout")
    ...
    async def _udp_announce(
        ...
        # [connection_id][action=1][transaction_id][info_hash][peer_id][downloaded][left][uploaded][event][IP][key][num_want][port]
        ...
        try:
            ...
            raise TrackerError("UDP announce timeout")
